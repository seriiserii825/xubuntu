...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_options_less__ = __webpack_require__(166);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_options_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__css_options_less__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__options_App__ = __webpack_require__(168);
...
Object(__WEBPACK_IMPORTED_MODULE_5_react_dom__["render"])(__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__options_App__["a" /* default */], null), window.document.getElementById('main'));
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./options.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./options.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "body {\n  font-family: 'Quicksand', sans-serif;\n  min-width: 700px;\n}\nnav #logo-container {\n  color: #444;\n  left: 50%;\n  transform: translateX(-50%);\n}\nnav {\n  font-weight: 100;\n  user-select: none;\n}\nnav #logo-container {\n  cursor: default;\n}\nnav .nav-wrapper i {\n  font-size: 1.2rem;\n  color: #ff7676;\n}\nnav #rate-me a {\n  color: #444;\n  font-size: 1.2rem;\n  transition: all 0.5s ease;\n}\nnav #rate-me a:hover {\n  color: #ff7676;\n}\n.dropdown-content li.dropdown-stop > a,\n.dropdown-content li.dropdown-stop > span {\n  color: #ff7676;\n  font-weight: 600;\n}\n.mui-toggle {\n  padding-bottom: 10px;\n}\n.table-title {\n  font-size: 1.6rem;\n  font-weight: 300;\n  padding-bottom: 10px;\n}\n.collection.tab-list {\n  overflow: visible;\n}\n.tab-list .collection-item.avatar span.title {\n  font-size: 17px;\n}\n.tab-list .collection-item.avatar p {\n  font-size: 13px;\n}\n.tab-list .dropdown-content li > a,\n.tab-list .dropdown-content li > span {\n  font-size: 0.9rem;\n}\n.tab-list .dropdown-button {\n  width: 120px;\n  font-size: 0.9rem;\n}\n.container .switch {\n  padding-bottom: 20px;\n}\n.container .switch label {\n  font-size: 16px;\n}\n.container .switch .lever {\n  margin-left: 0;\n}\n.container .resetSettings {\n  margin-top: 10px;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Navbar__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_TabsTable__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_constants__ = __webpack_require__(4);
...
class App extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            showContextMenu: localStorage["showContextMenu"] === "false" ? false : true
        };
    }

    handleOptionChange(key, enable) {
        let options = Object.assign({}, this.state.options); //creating copy of object
        options[key] = enable; //updating value
        this.setState({ options: options });
        this.saveOptionChange(options);
    }

    saveOptionChange(options) {
        chrome.extension.getBackgroundPage().saveOptions(options);
    }

    handleResetSettings() {
        localStorage["showContextMenu"] = true;
        if (this.state.showContextMenu !== true) {
            chrome.extension.getBackgroundPage().updateContextMenus();
        }
        this.setState({
            options: __WEBPACK_IMPORTED_MODULE_3__utils_constants__["b" /* DEFAULT_OPTIONS */],
            showContextMenu: true
        });
        this.saveOptionChange(__WEBPACK_IMPORTED_MODULE_3__utils_constants__["b" /* DEFAULT_OPTIONS */]);
    }

    handleContextMenuChange(e) {
        localStorage["showContextMenu"] = e.target.checked;
        this.setState({ showContextMenu: e.target.checked });
        chrome.extension.getBackgroundPage().updateContextMenus();
    }

    render() {
        const { options, showContextMenu } = this.state;
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_TabsTable__["a" /* default */], { handleOptionChange: (key, enable) => this.handleOptionChange(key, enable), options: options }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'h4',
                    { className: 'table-title context-title' },
                    'Context Menu'
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'form',
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'label',
                            null,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'checkbox', onChange: e => this.handleContextMenuChange(e), checked: showContextMenu }),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', { className: 'lever' }),
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'a',
                    { className: 'waves-effect waves-light btn resetSettings', onClick: () => this.handleResetSettings() },
                    'Reset Settings'
                )
            )
        );
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_constants__ = __webpack_require__(4);




class TabsTable extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {

    render() {
        const { handleOptionChange, options } = this.props;

        const optionNodes = __WEBPACK_IMPORTED_MODULE_2__utils_constants__["e" /* OPTIONS_DESC */].map((oDesc, index) => {
            const optionKey = Object.keys(oDesc)[0];
            const optionDesc = Object.values(oDesc)[0];
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'switch', key: optionKey },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'label',
                    null,
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'checkbox', onChange: e => handleOptionChange(optionKey, e.target.checked), checked: options[optionKey] }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', { className: 'lever' }),
                    optionDesc
                )
            );
...
TabsTable.propTypes = {
    handleOptionChange: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func.isRequired,
    options: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.object.isRequired
};

/* harmony default export */ __webpack_exports__["a"] = (TabsTable);
