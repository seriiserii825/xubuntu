            ...
            _showTheUpdateMessage() {
                ...
                if (updated) {
					...
					`;
                        ...
                        modalMsg.innerHTML = `
						<ul>
							<li><b>Fixed</b> a problem with always showing the resize tooltip caused by a new bug in the Chrome permissions API.</li>
						</ul>
