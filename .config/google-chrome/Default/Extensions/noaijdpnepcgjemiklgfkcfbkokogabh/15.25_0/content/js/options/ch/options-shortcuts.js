...
//  GEBI('SL_keys').appendChild(document.createTextNode(FExtension.element(FExtension.store.get("SL_LOCALIZATION"),'extUseHK')));
  ...
  switch(PLATFORM){
	 case "Opera" : GEBI('SL_info').href="http://about.imtranslator.net/tutorials/presentations/imtranslator-for-opera/imtranslator-opera-shortcuts/"; break;
	 case "Chrome": GEBI('SL_info').href="http://about.imtranslator.net/tutorials/presentations/imtranslator-for-chrome/imtranslator-chrome-hotkeys/"; break;
